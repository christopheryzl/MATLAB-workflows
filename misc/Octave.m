function [out] = Octave(psd,f,windscreen,micType)
% Octave band SPL from a narrowband PSD spectrum.
%
...
%   out.spl : band SPL [dB re 20 uPa]
    ...
    % ANSI S1.11 base-10 octave centres (see wikipedia), 16 Hz to 20 kHz
    fcAll     = 10.^((12:3:43)/10);
    fLowerAll = fcAll / 10^(3/20);
    fUpperAll = fcAll * 10^(3/20);
